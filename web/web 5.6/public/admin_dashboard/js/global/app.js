...
(function(window, document, $, undefined) {
  "use strict";
  var Suttikan = window.Suttikan || (window.Suttikan = {});
  if (Modernizr.touchevents) {
    Suttikan.APP_TOUCH = true;
  } else {
    Suttikan.APP_TOUCH = false;
  }
  Suttikan.APP_MEDIAQUERY = {
    XLARGE: "1280px",
    LARGE: "992px",
    MEDIUM: "768px",
    SMALL: "576px",
...
(function(window, document, $, undefined) {
  ...
  $(function() {
    ...
    **/
    ...
    if (
      Modernizr.mq("(max-width: " + Suttikan.APP_MEDIAQUERY.XLARGE + ")")
    ) {
...
var removeBackdrop = function() {
  if ($("#3-col-wrapper").length) {
    ...
    if (
      ...
      Modernizr.mq("(min-width: " + Suttikan.APP_MEDIAQUERY.XLARGE + ")")
    ) {
  ...
  if ($(".js-switch").length > 0) {
    ...
    elems.forEach(function(html) {
      var switchery = new Switchery(html, {
        ...
        secondaryColor: Suttikan.APP_COLORS.lightergrey
      });
    });
  }
