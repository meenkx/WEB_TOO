	...
	$(function() {
		...
		if ($('#morris_area_chart').length && $('#morris_line_chart').length && $('#morris_bar_chart').length && $('#morris_stacked').length && $('#morris_pie_chart').length) {
			...
			config = {
				...
				lineColors: [Suttikan.APP_COLORS.primary, Suttikan.APP_COLORS.success],
				barColors: [Suttikan.APP_COLORS.primary, Suttikan.APP_COLORS.success]
			};
			...
			Morris.Donut({
				...
				colors: [Suttikan.APP_COLORS.success, Suttikan.APP_COLORS.grey800, Suttikan.APP_COLORS.primary, Suttikan.APP_COLORS.grey500]
			});
		}
