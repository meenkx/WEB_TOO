...
(function(window, document, $, undefined) {
  ...
  $(function() {
    ...
    gradient.addColorStop(0, Chart.helpers.color(Suttikan.APP_COLORS.warning).alpha(0.9).rgbString());
    ...
    var config = {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderWidth: 2,
          borderColor: Suttikan.APP_COLORS.warning,
          pointBackgroundColor: Chart.helpers.color(Suttikan.APP_COLORS.warning).alpha(1).rgbString(),
