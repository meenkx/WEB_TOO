...
(function(window, document, $, undefined) {
  ...
  $(function() {
    ...
    gradient.addColorStop(0, Chart.helpers.color(Suttikan.APP_COLORS.primary).alpha(0.9).rgbString());
    ...
    var config = {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderWidth: 2,
          borderColor: Suttikan.APP_COLORS.primary,
          pointBackgroundColor: Chart.helpers.color(Suttikan.APP_COLORS.primary).alpha(1).rgbString(),
